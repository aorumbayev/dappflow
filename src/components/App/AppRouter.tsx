...
import SetNetwork from "../Modules/SetNetwork/SetNetwork";
                ...
                <Routes>
                  <Route path="/explorer" element={<Explorer></Explorer>}>
                    ...
                    >
                      ...
                      <Route
                        path="created-assets"
                        element={<AccountCreatedAssets></AccountCreatedAssets>}
                      />
                      <Route
                    ...
                    <Route
                      path="/explorer/transaction/:id"
                      element={<Transaction></Transaction>}
                    ></Route>
                    <Route
                      path="/explorer/group/:id/:blockId"
                      element={<Group></Group>}
                    >
                      <Route
                        path="transactions"
                  ...
                  <Route
                    path="/abi-studio"
                    element={<ABIStudio></ABIStudio>}
                  ></Route>
                  <Route
                    path="/dispenser"
                    element={<Dispenser></Dispenser>}
                  ></Route>
                  <Route
                    path="/node-status"
                    element={<NodeStatus></NodeStatus>}
                  ></Route>
                  <Route
                    path="/dev-wallets"
                    element={<DevWallets></DevWallets>}
                  ></Route>
                  <Route
                    path="/setup-config"
                    element={<SetupConfig></SetupConfig>}
                  ></Route>
